...
~/Rong/MUMmer/mummer-4.0.0beta5/mummerplot -t png --fat Hsub_unsolid_Bmori.delta -p Hsub_unsolid_Bmori --large
...
~/Rong/MUMmer/mummer-4.0.0beta5/mummerplot -t png --fat Hsub_solid_Bmori.delta -p Hsub_solid_Bmori --large
...
~/Rong/MUMmer/mummer-4.0.0beta5/mummerplot -t png --fat Hzea_unsolid_Bmori.delta -p Hzea_unsolid_Bmori --large
...
~/Rong/MUMmer/mummer-4.0.0beta5/mummerplot -t png --fat Hzea_solid_Bmori.delta -p Hzea_solid_Bmori --large
...
~/Rong/MUMmer/mummer-4.0.0beta5/mummerplot -t png --fat Harm_unsolid_Bmori.delta -p Harm_unsolid_Bmori --large
...
~/Rong/MUMmer/mummer-4.0.0beta5/mummerplot -t png --fat Harm_solid_Bmori.delta -p Harm_solid_Bmori --large
